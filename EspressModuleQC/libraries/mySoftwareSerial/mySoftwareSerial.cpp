...
SoftwareSerial::SoftwareSerial(bool defer) {
	//do nothing, must call mySerialSetup to startup, allows dynamic stuffs...
	//Serial.println("defer");
}


void SoftwareSerial::mySerialSetup(int receivePin, int transmitPin, bool inverse_logic, unsigned int buffSize)   //dp my addition for dynamic creation of pins
{
